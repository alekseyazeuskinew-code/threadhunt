...
export function Select({
  ...
  return (
    <div ref={ref} className={cn('relative', className)}>
      ...
      {open && (
        <div className="anim-pop absolute z-50 mt-1.5 max-h-64 w-full min-w-max overflow-y-auto rounded-xl border border-line bg-panel p-1 shadow-xl shadow-black/30">
          {options.map((o) => (
            <button
              key={o.value}
              type="button"
