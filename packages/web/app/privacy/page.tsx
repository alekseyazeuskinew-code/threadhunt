  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-12">
      ...
      <div className="mt-8 space-y-6 text-sm leading-relaxed text-text/90">
        ...
        <Section title="7. Обезличенная аналитика для улучшения сервиса">
          Если вы дали согласие при регистрации, мы используем <b>обезличенную и агрегированную</b> статистику работы ваших
